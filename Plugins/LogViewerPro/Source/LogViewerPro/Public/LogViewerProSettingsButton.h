...
public:
	...
	JSON_SERIALIZE("MinimizeCategories", bMinimizeCategories);
	END_JSON_SERIALIZER
};
...
public:
	...
	bool IsMinimizeCategories() const;

	void TryLoadAndApplySettings();

	//@TODO move default paths to appropriate location
	static FString GetDefaultNamedTabsFolderPath();

	FLVSettingsData GetSettingsData() const { return SettingsData; };
