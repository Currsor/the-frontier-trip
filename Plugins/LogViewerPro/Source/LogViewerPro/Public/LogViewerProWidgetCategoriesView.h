...
public:
	void LoadCategoriesFromFile(const FString& Path);  //Now settings menu requires this to save named tabs
private:
...
public:
	void SaveCategoriesIntoFile(const FString& Filename); //Now settings menu requires this to save named tabs
...
public: // :P - @HACK making it public indicates class responsibility violation
