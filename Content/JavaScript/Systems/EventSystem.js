...
class EventSystem {
     ...
     */
    static subscribe(event, callback, priority = 0) {
     ...
     */
    static emit(event, data, immediate = true) {
        // 记录事件历史
     ...
     * @param data 事件数据
     */
    static executeCallbacks(event, callbacks, data) {
     ...
     * @param data 事件数据
     */
    static addToHistory(event, data) {
     ...
     * @returns 事件历史记录
     */
    static getEventHistory(event, limit = 10) {
     ...
     * @param event 事件名称
     */
    static clearEventListeners(event) {
     ...
     * @param priority 优先级
     */
    static once(event, callback, priority = 0) {
